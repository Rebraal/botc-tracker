...
function renderRoster() {
  ...
  // Isolated keystroke event mapper block
  let rosterInput = document.getElementById('input-player-name');
  if (rosterInput) {
    rosterInput.onkeydown = (e) => { if (e.key === 'Enter') addPlayerFromInput(); };
  }
}
...
function triggerNewGame() {
  state = { players: [], votes: [], currentDay: 1, highestDayReached: 1, setupMode: true, nominationState: 'IDLE', nominatorToday: [], nomineeToday: [] };
